...
class WhiteLabelServiceProvider extends ServiceProvider
{
    ...
    {
        \Eventy::addFilter('chat.powered_by', function($html) {
            return '';
        });
        \Eventy::addFilter('knowledgebase.powered_by', function($html) {
            return '';
        });
        \Eventy::addFilter('enduserportal.powered_by', function($html) {
            return '';
        });
    }
