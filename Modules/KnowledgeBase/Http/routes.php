...
// Frontend
Route::group(['middleware' => [\App\Http\Middleware\EncryptCookies::class, \Illuminate\Session\Middleware\StartSession::class, \App\Http\Middleware\HttpsRedirect::class, \App\Http\Middleware\Localize::class], 'prefix' => \Helper::getSubdirectory(), 'namespace' => 'Modules\KnowledgeBase\Http\Controllers'], function()
{
    Route::get('/hc', 'KnowledgeBaseController@index')->name('knowledgebase.frontend.index');
