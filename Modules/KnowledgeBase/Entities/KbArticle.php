...
class KbArticle extends Model
{
    ...
    public function urlFrontend($mailbox, $category_id = null)
    {
        ...
        if ($this->slug) {
            ...
            $url = \Kb::route('knowledgebase.frontend.article', $params, $mailbox);
        } else {
            $url = \Kb::route('knowledgebase.frontend.article_without_slug', $params, $mailbox);
        }
        return \Kb::urlToFrontend($url, $mailbox);
    }
