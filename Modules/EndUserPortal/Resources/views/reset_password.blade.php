					...
					@else
	                    <form class="margin-top" method="POST" action="">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
	                            ...
	                            <input id="password_confirmation" type="password" class="form-control input-md" name="password_confirmation" value="" placeholder="{{ __('Confirm Password') }}" required autofocus>
