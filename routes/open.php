...
// Current attachment URL format, generated by Attachment::url().
Route::get('/storage/attachment/download/{id}/{token}', 'OpenController@downloadAttachmentById')->name('attachment.download.by_id');
// Open tracking
