...
class WebklexHeaderTest extends TestCase {
    ...
    public function testHeaderParsing(): void {
        ...
        self::assertSame("Тралалело Тралала Тралалеловна", $from->personal);
        ...
        self::assertSame("Тралалело Тралала Тралалеловна <notifications@github.com>", $from->full);
    ...
    public function testExtractHeaderExtensions2() {
        ...
        $this->assertArrayHasKey('content_type', $mock->getAttributes());
        $this->assertEquals('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', $mock->get('content_type'));
