		...
		<tr>
			<td>
				<table class="content" width="100%" border="0" cellspacing="0" cellpadding="0">
				    <tr>
				        <td height="45" valign="bottom"><p align="center" style="font-family:Arial, 'Helvetica Neue', Helvetica, Tahoma, sans-serif; font-size:12px; color:#B5B9BD; line-height:16px; margin:0;">{{ App\Mail\Mail::REPLY_SEPARATOR_TEXT }}</p></td>
				    </tr>
				    <tr>
				        <td height="20"></td>
				    </tr>
							            ...
							            <p style="font-family:Arial, 'Helvetica Neue', Helvetica, Tahoma, sans-serif; line-height:15px; margin:0; font-size:12px; color:#a1a6ab; padding-bottom: 0.75em;">
							            	...
							            	@else
			                                    ...
			                                    @elseif ($thread->action_type == App\Thread::ACTION_TYPE_USER_CHANGED)
													...
													{{ __("assigned to :person conversation", ['person' => $thread->getAssignedName()]) }}
			                                    @else
							    ...
							    <tr>
							        ...
							        <td align="right" valign="top">
							            <table border="0" cellspacing="0" cellpadding="5" style="margin-top: 5px;">
							                <tr>
							                    <td height="10" bgcolor="#43ac6d" style="color:#ffffff; font-family:Arial, 'Helvetica Neue', Helvetica, Tahoma, sans-serif; line-height:12px; font-size:12px; margin-top: 3px;border-radius: 2px;">{{ strtoupper($conversation->getStatusName()) }}</td>
							                </tr>
							            </table>
									                    ...
									                    <td>
															...
															@if ($thread->type != App\Thread::TYPE_NOTE)
																<p style="display:inline; font-family:Arial, 'Helvetica Neue', Helvetica, Tahoma, sans-serif; color:#B5B9BD; font-size:11.5px; line-height:18px; margin:0;">
															    	{{ __('Assigned:') }} {{ $thread->getAssignedName(true) }} &nbsp;&nbsp;&nbsp; {{ __('Status:') }} {{ $thread->getStatusName() }}<br>
															    </p>
															@endif
									                    </td>
									                    <td valign="top">
