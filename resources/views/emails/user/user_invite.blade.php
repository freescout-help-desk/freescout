...
@section('content')
	...
	<p>
		<a href="{{ $user->urlSetup() }}" style="background:#337ab7;border-color:#337ab7;border-radius:3px;border-style:solid;border-width:8px 18px;color:#ffffff;display:inline-block;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;text-decoration:none" target="_blank">{{ __('Create a Password') }}</a>
	</p>
	...
	<p style="color:#72808e;font:400 16px/26px 'Helvetica Neue',Helvetica,Arial,sans-serif;padding:0">
		{!! __(':app is for companies that need to share an inbox, support customers and stay in sync as a team. Someone on your team created an account for you.', ['app' => '<a href="'.\Config::get('app.freescout_url').'" style="border:0;color:#3197d6;text-decoration:none" target="_blank">'.\Config::get('app.name').'</a>']) !!}
	</p>
@endsection