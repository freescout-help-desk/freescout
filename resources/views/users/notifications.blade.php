            ...
            <div class="col-md-11 col-lg-9">
                ...
                <table class="table margin-top">
                    <tr class="table-header">
                        ...
                        <td class="text-center">{{ __('Mobile') }}<br/><small>(<a href="@filter('notifications.android_link', '')" target="_blank">Android</a>)</small><br/><input type="checkbox" class="sel-all" @if (!$mobile_available) disabled="disabled" @endif value="mobile"></td>
                    </tr>
                    <tr>
