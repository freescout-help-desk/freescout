...
<table class="table" style="margin-bottom: 0;">
    <tr class="table-header">
        ...
        <td class="text-center">{{ __('Telegram') }}<br/><input type="checkbox" class="sel-all" value="telegram"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_NEW_CONVERSATION]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_NEW_CONVERSATION }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_CONVERSATION_ASSIGNED_TO_ME]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_CONVERSATION_ASSIGNED_TO_ME }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_CONVERSATION_ASSIGNED]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_CONVERSATION_ASSIGNED }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_FOLLOWED_CONVERSATION_UPDATED]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_FOLLOWED_CONVERSATION_UPDATED }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_MY_TEAM_MENTIONED]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_MY_TEAM_MENTIONED }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_CUSTOMER_REPLIED_TO_UNASSIGNED]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_CUSTOMER_REPLIED_TO_UNASSIGNED }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_CUSTOMER_REPLIED_TO_MY]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_CUSTOMER_REPLIED_TO_MY }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_CUSTOMER_REPLIED_TO_ASSIGNED]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_CUSTOMER_REPLIED_TO_ASSIGNED }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_USER_REPLIED_TO_UNASSIGNED]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_USER_REPLIED_TO_UNASSIGNED }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_USER_REPLIED_TO_MY]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_USER_REPLIED_TO_MY }}"></td>
    ...
    <tr>
        ...
        <td class="subscriptions-telegram"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_TELEGRAM, 'event' => App\Subscription::EVENT_USER_REPLIED_TO_ASSIGNED]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_TELEGRAM }}][]" value="{{ App\Subscription::EVENT_USER_REPLIED_TO_ASSIGNED }}"></td>
