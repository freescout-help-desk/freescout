            ...
            <div class="col-xs-12">
                <form class="form-horizontal" method="POST" action="">
                    ...
                    <div class="form-group{{ $errors->has('in_password') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-6">
                            <input id="in_password" type="password" class="form-control input-sized" name="in_password" value="" placeholder="{{ old('out_password', !is_null($mailbox->in_password ? '****' : '') }}" maxlength="255" required autofocus {{-- This added to prevent autocomplete in Chrome --}}autocomplete="new-password">
