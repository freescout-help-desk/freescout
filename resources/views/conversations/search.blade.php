...
@section('content')
	...
	<div class="search-results">
		<ul class="nav nav-tabs nav-tabs-main margin-top">
		    <li @if ($mode == App\Conversation::SEARCH_MODE_CONV)class="active search-tab-conv"@endif><a href="">{{ __('Conversations') }} <b>({{ $conversations->total() }})</b></a></li>
		    <li @if ($mode == App\Conversation::SEARCH_MODE_CUSTOMERS)class="active"@endif><a href="">{{ __('Customers') }} <b>({{ $customers->total() }})</b></a></li>
		</ul>
