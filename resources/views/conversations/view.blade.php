                    ...
                    <div class="thread thread-type-{{ $thread->getTypeName() }}" id="thread-{{ $thread->id }}">
                        ...
                        <div class="thread-message">
                            <div class="thread-header">
                                ...
                                <div class="thread-info">
                                    <span class="thread-date" data-toggle="tooltip" title="{{ App\User::dateFormat($thread->created_at, 'M j, Y H:i:s') }}" >{{ App\User::dateDiffForHumans($thread->created_at) }}</span><br/>
