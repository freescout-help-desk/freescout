...
class Mail
{
    ...
    const MAIL_SCHEDULE_EVERY_MINUTE = 1;
    const MAIL_SCHEDULE_EVERY_FIVE_MINUTES = 5;
    const MAIL_SCHEDULE_EVERY_TEN_MINUTES = 10;
    const MAIL_SCHEDULE_EVERY_FIFTEEN_MINUTES = 15;
    const MAIL_SCHEDULE_EVERY_THIRTY_MINUTES = 30;
    const MAIL_SCHEDULE_HOURLY = 60;
